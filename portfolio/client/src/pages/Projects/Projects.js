            ...
            <div className="col-md-4">
              <div className="card rounded">
                ...
                <div className="card-body text-center">
                  ...
                  <a
                    className="ad-btn"
                    href="https://github.com/cntbabul/htdocs/tree/ab6b1e8134c60dde59effbe982068414c6921587/mernBloodBankApp"
                  >
                    view on Github
                  </a>
                </div>
            ...
            <div className="col-md-4">
              <div className="card rounded">
                ...
                <div className="card-body text-center">
                  ...
                  <a
                    className="ad-btn"
                    href="https://github.com/cntbabul/htdocs/tree/ab6b1e8134c60dde59effbe982068414c6921587/portfolio/client"
                  >
                    view on Github
                  </a>
                </div>
